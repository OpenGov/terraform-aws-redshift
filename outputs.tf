...
output "this_redshift_snapshot_copy_grant_arn" {
  description = "The ARN of Redshift snapshot copy grant created by this module"
  value       = "${element(concat(aws_redshift_snapshot_copy_grant.this.*.id, list("")), 0)}"
}
